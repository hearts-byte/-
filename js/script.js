...
document.addEventListener('DOMContentLoaded', () => {
  ...
  visitorForm.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      showMessage('تم دخولك كزائر بنجاح! جاري تحويلك إلى الغرف...', 'success');
  ...
  registerForm.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      showMessage('تم إنشاء حسابك بنجاح! جاري تحويلك إلى الغرف...', 'success');
      localStorage.setItem('fromRegistrationPage', 'true');
      setTimeout(() => {
        window.location.href = 'index.html';
      }, 2000);
  ...
  memberForm.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      showMessage('تم تسجيل الدخول بنجاح! جاري تحويلك إلى الدردشة...', 'success');
      localStorage.setItem('fromRegistrationPage', 'true');
      setTimeout(() => {
        window.location.href = 'index.html';
      }, 2000);
